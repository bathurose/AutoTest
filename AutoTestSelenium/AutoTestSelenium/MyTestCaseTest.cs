...
public class MyTestCaseTest
{
    ...
    public void StartAzure()
    {
        ...
        {         
            ...
            driver.FindElement(By.Id("i0116")).SendKeys("sorismbazure@hotmail.co.jp");
            Thread.Sleep(1000);
            driver.FindElement(By.Id("idSIButton9")).Click();

            // パスワードを追加
            wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("i0118")));
            driver.FindElement(By.Id("i0118")).SendKeys("86wiufqQFsa98fqeqfs28csF@dev");
            Thread.Sleep(1000);
            driver.FindElement(By.Id("idSIButton9")).Click();
            ...
            TestCases("sorimachivn-test-env", "start");
    ...
    // クラウドサービスの開始/停止
    public bool TestCases(string listCloudService, string listState)
    {
        try
        { 
            int countAttend = 0;
            ...
            if (IsElementPresent(By.XPath("//span[contains(text(),'No deployment')]")) == false)
            {
                var curState = driver.FindElement(By.XPath("//div[@title=\'Stop\'  or @title=\'Start\' or @title=\'開始\' or @title=\'停止\' ]")).GetAttribute("title");
                if (String.Compare("stop", listState, true) == 0 || String.Compare("start", listState, true) == 0 || String.Compare("停止", listState, true) == 0 || String.Compare("開始", listState, true) == 0)
                {
                    //if (String.Compare(curState, "stop", true) == 0 || String.Compare(curState, "停止", true) == 0)
                        if (String.Compare(curState, "start", true) == 0 || String.Compare(curState, "開始", true) == 0)
                        {
                        countAttend++;
            ...
            wait_30.Until(ExpectedConditions.ElementToBeClickable((By.XPath("//div[@title=\'Production\']"))));
            driver.FindElement(By.XPath("//div[@title=\'Production\']")).Click();

            wait_30.Until(ExpectedConditions.ElementToBeClickable((By.XPath("//div[@title=\'Production\']"))));
            driver.FindElement(By.XPath("//div[@title=\'Production\']")).Click();

            wait_30.Until(ExpectedConditions.ElementToBeClickable((By.XPath("//li[@title=\'Staging\']"))));
            driver.FindElement(By.XPath("//li[@title=\'Staging\']")).Click();
